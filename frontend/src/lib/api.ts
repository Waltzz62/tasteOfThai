...
export const authApi = {
  ...
  staffLogin: (data: any) => fetchApi('/auth/staff/login', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
};
...
export const classesApi = {
  ...
  create: (data: any) => fetchApi('/classes', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => fetchApi(`/classes/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id: string) => fetchApi(`/classes/${id}`, {
    method: 'DELETE',
  }),
};
...
export const schedulesApi = {
  ...
  create: (data: any) => fetchApi('/schedules', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => fetchApi(`/schedules/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id: string) => fetchApi(`/schedules/${id}`, {
    method: 'DELETE',
  }),
};
...
export const bookingsApi = {
  ...
  updateStatus: (id: string, status: string) => fetchApi(`/bookings/${id}/status`, {
    method: 'PATCH',
...
export const staffApi = {
  ...
  update: (id: string, data: any) => fetchApi(`/staff/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
...
export const staffApplicationsApi = {
  create: (data: any) => fetchApi('/staff-applications', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  getAll: () => fetchApi('/staff-applications'),
  getById: (id: string) => fetchApi(`/staff-applications/${id}`),
  update: (id: string, data: any) => fetchApi(`/staff-applications/${id}`, {
    method: 'PATCH',
    body: JSON.stringify(data),
  }),
};